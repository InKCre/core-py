...
清单以 `66ce59f` 为实现基线。下表列出直接 session/connection 引用文件；间接消费者随接口一起迁移，不将文本命中数当成调用图覆盖率。

| 对象 | 计划步骤 | 状态 |
| --- | --- | --- |
| `app/business/agent/main.py` | 03 | 待迁移 |
| `app/business/ai/main.py` | 03 | 待迁移 |
| `app/business/cron.py` | 06 | 待迁移 |
| `app/business/deployment_config.py` | 03 | 待迁移 |
| `app/business/extension/state.py` | 05 | 待迁移 |
| `app/business/graph_navigation_retrieval/main.py` | 08 | 待迁移 |
| `app/business/info_base/block.py` | 02 → 04 | 待迁移 |
| `app/business/info_base/main.py` | 02 → 04 | 待迁移 |
| `app/business/info_base/relation.py` | 02 → 04 | 待迁移 |
| `app/business/info_base/resolver/main.py` | 02 → 04 | 待迁移 |
| `app/business/info_base/storage/main.py` | 02 → 04 | 待迁移 |
| `app/business/info_base/storage/postgresql.py` | 02 → 04 | 待迁移 |
| `app/business/job.py` | 06 | 待迁移 |
| `app/business/lexical_retrieval/main.py` | 08 | 待迁移 |
| `app/business/organization/_shared.py` | 08 | 待迁移 |
| `app/business/organization/duplicate_assertion.py` | 08 | 待迁移 |
| `app/business/organization/evidence_stance.py` | 08 | 待迁移 |
| `app/business/organization/referent_anchoring.py` | 08 | 待迁移 |
| `app/business/organization/refinement.py` | 08 | 待迁移 |
| `app/business/organization/rumination.py` | 08 | 待迁移 |
| `app/business/organization/supersession.py` | 08 | 待迁移 |
| `app/business/organization/synthesis.py` | 08 | 待迁移 |
| `app/business/organization_media.py` | 08 | 待迁移 |
| `app/business/peer/main.py` | 03 | 待迁移 |
| `app/business/semantic_retrieval/main.py` | 08 | 待迁移 |
| `app/business/sink/main.py` | 06 | 待迁移 |
| `app/business/source/config.py` | 06 | 待迁移 |
| `app/business/source/job.py` | 06 | 待迁移 |
| `app/business/source/main.py` | 06 | 待迁移 |
| `app/database_contract/connection.py` | 09 | 待迁移 |
| `app/engine.py` | 02 → 10 | 待迁移 |
| `extensions/github/repository.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/github/resolver.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/github/stars.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/mail/repository.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/mail/resolver.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/mail/source.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/memos/family/attachment.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/memos/family/graph.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/memos/family/service.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/rss/enrichment.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/rss/repository.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/telegram/resolver.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/telegram/source.py` | 07（04/05 先适配接口） | 待迁移 |
| `extensions/twitter/bookmark.py` | 07（04/05 先适配接口） | 待迁移 |
| `libs/obsrv/log_handler_postgresql.py` | 09 | 待迁移 |
