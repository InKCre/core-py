...
- **阶段**：D-629–D-631 修正已纳入实现计划与 Handshake；关键补充核对完成。本次只获授权提交 packet，等待源码实施授权。
...
- **下一步**：提交已修正的设计/计划，等待实施授权；未修改源码，未来 Git/发布操作需另行授权。
- **文档修正**：D-631 纳入相关领域的 [authority 纠正与长期准则](documentation-authority.md)，不止补导航；拟新增 Hub meta 影响面，具体代码合同仍留 Core。
