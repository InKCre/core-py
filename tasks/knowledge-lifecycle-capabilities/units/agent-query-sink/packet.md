...
- **阶段**：Preview acceptance complete / Human review。P1–P4、本地门禁、真实模型 A1–A4 与修正后镜像 smoke
  已通过；PR #111 保持 draft 且未合并。证据见 [implementation-evidence](implementation-evidence.md)。
...
- **下一步**：等待 Sir review PR #111 与 Hub PR #29；不合并。后续合并、版本准备、production 与 PyPI 复验需
  单独授权后才能关闭 unit。
