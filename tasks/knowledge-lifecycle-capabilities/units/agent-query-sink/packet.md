...
- **阶段**：Preview acceptance。P1–P4、本地门禁与真实模型 A1–A4 已通过；等待 evidence/fix 对应的新 PR HEAD
  重部署 smoke。证据见 [implementation-evidence](implementation-evidence.md)。
...
- **下一步**：提交并推送 Preview 验收中发现的 CLI schema 错误修正与 evidence，等待 PR #111 的新 HEAD
  部署后完成最终 smoke；不合并。
