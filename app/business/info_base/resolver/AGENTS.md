...
- `get_str_for_embedding(...) -> str | None`
...
九个 core semantic resolvers 中，text/HTML 提供 text/embedding；image/audio/video/PDF/EPUB/ZIP/file 在没有
真实 OCR/STT/extraction 能力前显式 unsupported，不用 metadata 伪装正文。
