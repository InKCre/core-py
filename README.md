...
- Shared framework baseline: [docs/_shared/00-meta/_svc_v9_3.md](docs/_shared/00-meta/_svc_v9_3.md)
...
- Local unit architecture, if present: [docs/30-unit-tdd/](docs/30-unit-tdd/)
