...
def test_text_columns_match_the_published_migration_types():
  ...
  text_columns = {
    ...
    ("extension_peer_bindings", "namespace"),
    ("extension_peer_bindings", "name"),
    ("extension_peer_bindings", "version"),
    ("extension_peer_bindings", "target_key"),
    ("extension_peer_bindings", "target_digest"),
    ("extension_peer_bindings", "version"),
    ("logs", "severity_text"),
    ("logs", "body"),
    ("logs", "trace_id"),
...
def test_production_required_columns_are_not_nullable():
  ...
  required_columns = {
    ...
    ("extension_installations", "config_schema"),
    ("extension_installations", "version"),
    ("extension_peer_bindings", "target_key"),
    ("extension_peer_bindings", "target_digest"),
    ("logs", "timestamp"),
