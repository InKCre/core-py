...
def test_telegram_chat_schema():
  ...
  chat = TelegramChat(id=123456, type="private", username="johndoe")
  ...
  # Test group chat
  group_chat = TelegramChat(id=789012, type="group", title="Test Group")
  assert group_chat.title == "Test Group"


def test_telegram_message_schema():
  """Test Telegram message schema creation."""
  user = TelegramUser(id=12345, first_name="John", username="johndoe")
