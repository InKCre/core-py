...
class TestSettings:
    ...
    def test_settings_default_values(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            ...
            assert settings.logtail_source_token is None
            assert settings.logtail_host is None
    ...
    def test_settings_optional_logtail_fields(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            ...
            assert settings.logtail_source_token == 'test_token_123'
            assert settings.logtail_host == 'https://logs.example.com'
...
class TestSettingsIntegration:
    ...
    def test_settings_used_in_logging_config(self):
        ...
        with patch.dict(os.environ, env_vars, clear=True):
            ...
            assert settings.logtail_source_token == 'test_token'
